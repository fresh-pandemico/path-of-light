...
# يرجى استبدال "res://YouWinScreen.tscn" بالمسار الفعلي للمشهد التالي
const NEXT_SCENE_PATH = "res://YouWinScreen.tscn"
...
func start_game():
	# يُفضل استخدام get_children() إذا كانت كل البلاطات (Tiles) هي أبناء مباشرة لـ Area2D
	# وإلا، استمر في سردها يدوياً كما يلي:
